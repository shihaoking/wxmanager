...
('1','2','o6OX4t6rEXQCiWF12jrhidfojDpQ','','1','0','0','1400765823','','','','','','','0','0','0','0','0','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','');
...
('1','0','admin','fc0dbdf60c38b4d8e117d176e8a71b8f73f73f64','9bca3fd9','0','1400505881','','1400852697','192.168.80.2','');
...
('1','basic','','基本文字回复','1.0','和您进行简单对话','一问一答得简单对话. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的回复内容.','IdeaMax','','0','','','1','1'),
('2','news','','基本混合图文回复','1.0','为你提供生动的图文资讯','一问一答得简单对话, 但是回复内容包括图片文字等更生动的媒体内容. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的图文回复内容.','IdeaMax','','0','','','1','1'),
('3','music','','基本语音回复','1.0','提供语音、音乐等音频类回复','在回复规则中可选择具有语音、音乐等音频类的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝，实现一问一答得简单对话。','IdeaMax','','0','','','1','1'),
('4','userapi','','自定义接口回复','1.1','更方便的第三方接口设置','自定义接口又称第三方接口，可以让开发者更方便的接入微擎系统，高效的与微信公众平台进行对接整合。','IdeaMax','','0','','','1','1'),
('5','fans','customer','粉丝管理','1.1','关注的粉丝管理','','IdeaMax','','0','a:8:{i:0;s:4:\"text\";i:1;s:5:\"image\";i:2;s:5:\"voice\";i:3;s:5:\"video\";i:4;s:8:\"location\";i:5;s:4:\"link\";i:6;s:9:\"subscribe\";i:7;s:11:\"unsubscribe\";}','a:0:{}','0','1'),
('6','member','customer','微会员','1.2','会员管理','会员管理','IdeaMax','','0','a:0:{}','','0','1');
...
('1','default','微站默认模板','由IdeaMax提供默认微站模板套系','IdeaMax','');
...
('2','yAFGJ','1','1','OFO0fr26nOoI303v9fV6B0388869VVK2','a:2:{s:5:\"token\";s:86:\"T23gi9HC34eiu5GwTFS300rcYY-eI5deLWrJ21We_hjlZCyQwn79oVxGPoGcAtAm0-7d5A2DpT0NJf7b81tGcQ\";s:6:\"expire\";i:1400772862;}','微果篮','wxguolan','gh_0cfee326d639','','','','','','','','','','0','0','wx797ad8bee37afce2','0bdcd485baaea428b8f61d8b6b8538ec','1','','','a:2:{s:8:\"template\";s:7:\"default\";s:12:\"enablemodule\";a:1:{i:0;s:4:\"news\";}}','0','');
